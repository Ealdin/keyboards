...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_Quadrant_5x14(
    /* Base
      ...
      * |------+------+------+------+------+-------------+------+------+------+------+------+------+------|
      * | Esc  |   A  |   S  |   D  |   F  |   G  | Home | PgUp |   K  |   L  |   ;  |   9  |   0  |  "   |
      * |------+------+------+------+------+------|------+------+------+------+------+------+------+------|
  ...
  /* Layer 2 
      ...
      * `-------------------------------------------------------------------------------------------------'
      */
    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_MSTP, KC_MPLY, KC_TRNS, KC_TRNS, KC_TRNS, KC_MPRV, KC_VOLD, KC_MNXT, \
